      ...
      {!isDataLoading ? (
        <>
          <Card className="mt-16 w-[200px]">
            ...
            <CardContent className="">
              <div className="flex justify-row justify-between items-center space-y-0">
                <animated.div className="text-center text-2xl">{spentSpring.spent.to(val => `$${Math.floor(val).toLocaleString()}`)}</animated.div>
            ...
            <FullCalendar 
              ...
              eventContent={(info) => (
                <div className="text-center">
                  ...
                  <p className={info.event.start as Date > new Date() ? "bg-red-500" : "bg-teal-800"}>
          ...
          <div className="my-10 w-[300px] dark:text-white">
            <div className="text-sm mb-2">{date?.toLocaleString("en", {weekday: "long", day: "numeric"})}</div>
            <AnimatePresence>
